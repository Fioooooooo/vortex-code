...
import type { AgentEntry, AgentStatus, InstallProgress } from "@shared/types/agents";
  ...
  <UCard :ui="{ body: 'p-0!' }">
    <div class="flex flex-col gap-3 p-4">
      <div class="flex items-center gap-3">
        <div
          class="w-8 h-8 rounded-lg bg-white flex items-center justify-center shrink-0 overflow-hidden border border-default"
        >
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center gap-1.5">
            <span class="text-xs text-muted/60">v{{ agent.version }}</span>
        ...
        <div class="flex flex-col items-end gap-2 shrink-0">
          ...
          <template v-else-if="canUpdate">
            <UBadge color="warning" variant="soft">Update Available</UBadge>
            <UButton size="xs" color="primary" :disabled="actionDisabled" @click="requestInstall">
