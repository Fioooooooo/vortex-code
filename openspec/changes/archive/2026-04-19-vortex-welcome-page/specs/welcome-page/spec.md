...
The system SHALL display the Welcome page in full-screen when no project is currently open.
...
- **AND** the Activity Bar and project switcher are not visible

### Requirement: Welcome page shows brand identity

The system SHALL display the FylloCode logo, product name, and tagline centered at the top of the Welcome page.
...
- **AND** upon selection, the system enters the Workspace with the chosen directory
